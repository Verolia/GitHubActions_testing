...
namespace Api.Infrastructure.Persistence.EconomyManagement
{
    public class EconomyManagementDbContext : DbContext
    {
        public EconomyManagementDbContext(DbContextOptions<EconomyManagementDbContext> options)
            : base(options)
        {
        }
