...
namespace Api.Infrastructure.Persistence.CafeFloorManagement
{
    public class CafeFloorManagementDbContext : DbContext
    {
        public CafeFloorManagementDbContext(DbContextOptions<CafeFloorManagementDbContext> options)
            : base(options)
        {
        }
