...
namespace Api.Infrastructure.Persistence.ContentAndPromotions
{
    public class ContentAndPromotionsDbContext : DbContext
    {
        public ContentAndPromotionsDbContext(DbContextOptions<ContentAndPromotionsDbContext> options)
            : base(options)
        {
        }
